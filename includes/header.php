...
<div class="full">
    <div class="col-md-3 top-nav register" style="background-color: #0BE0FD; padding-bottom: 200px;">
        <div class="logo">
            <style>
                .btn-social {
                    width: 100px;
            ...
            <center><a href="home.php"><img src="image_uploads/logo_CEMK.png" class="img-responsive" width="150px"></a>  </center> 
        </div>
        <div class="top-menu">
